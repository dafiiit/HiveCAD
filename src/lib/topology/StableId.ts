...
export type SemanticTag =
    ...
    | 'top_cap'       // Top cap (for cylinder/cone)
    | 'bottom_cap'    // Bottom cap (for cylinder/cone)
    | 'outer'         // Outer surface (sphere/torus)
    | 'inner'         // Inner surface (torus/shell)
    | 'generated'     // Generated by operation (boolean)
